...
export default async function FreshworksProducts() {
  const t = await getTranslations("freshworksProducts");
  ...
  return (
    <section data-testid="freshworks-products" className="section-padding bg-gray-50">
